<div x-data="{ filterOpen: false }" class="flex w-full p-6 mt-6">
    <section class="w-full">
        <div class="w-full flex items-center bg-white gap-x-4 mb-4 p-4">
            ...
            <input type="text" placeholder="Szukaj..." class="w-full h-8 px-2 rounded-sm border-2 focus-visible:outline-none focus:border-green-500 transition duration-150 ease-in-out" wire:model.live="search" />
        </div>
        <!-- Filtr sortowania -->
        <div class="relative">
