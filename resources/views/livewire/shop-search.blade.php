<div x-data="{ filterOpen: false, itemsPerPageOpen: false, categoryFilterOpen: false, itemsPerPage: 12 }"
     class="flex w-full p-6 mt-6">
    @if($items->first())
        <section class="mx-auto">
            <div
                class="w-full flex flex-col md:flex-row items-center justify-between bg-gray-100 rounded-lg gap-4 mb-6 p-4 shadow-md">
                <!-- Pasek wyszukiwania -->
                <div class="flex items-center w-full md:w-1/2 bg-white p-2 rounded-lg shadow-sm">
                    ...
                    <input type="text" placeholder="Szukaj..."
                           class="w-full h-10 px-3 rounded-md border-0 focus:ring-0 focus:outline-none"
                ...
                <div class="flex flex-col gap-y-4 md:gap-y-0 md:flex-row">
                    ...
                    <!-- Filtr kategorii -->
                    <div class="relative w-full md:w-1/3 mr-4">
                        <button @click="categoryFilterOpen = !categoryFilterOpen"
                                class="flex items-center justify-between w-full md:w-auto px-4 py-2 bg-green-600 text-white font-semibold rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                            Kategorie
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="ml-2 w-5 h-5">
                        ...
                        <div x-show="categoryFilterOpen" @click.away="categoryFilterOpen = false" x-cloak
                            ...
                            <ul class="divide-y divide-gray-200">
                                <li wire:key="all-categories">
                                    <button wire:click="$set('categoryOption', '')" @click="categoryFilterOpen = false"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Wszystkie
                                    </button>
                                </li>
                    ...
                    <div class="relative w-full md:w-auto">
                        ...
                        <div x-show="filterOpen" @click.away="filterOpen = false" x-cloak
                            ...
                            <ul class="divide-y divide-gray-200">
                                <li>
                                    <button wire:click="$set('sortOption', 'price_asc')"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Cena: rosnąco
                                    </button>
                                </li>
                                <li>
                                    <button wire:click="$set('sortOption', 'price_desc')"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Cena: malejąco
                                    </button>
                                </li>
                                <li>
                                    <button wire:click="$set('sortOption', 'alphabetical')"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Alfabetycznie
                                    </button>
                                </li>
                                <li>
                                    <button wire:click="$set('sortOption', 'latest')"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Ostatnio dodane
                                    </button>
                                </li>
    ...
    @else
        <div class="flex items-center justify-center h-[20vh] w-full">
            <h1 class="text-4xl text-center">Aktualnie nie odnaleziono żadnych przedmiotów w sklepie. <br> Przepraszamy
                za utrudnienia. &#128575;</h1>
        </div>
    @endif
</div>
