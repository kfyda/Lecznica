<div x-data="{ itemsPerPageOpen: false }" class="flex mx-auto">
    @if($newsCollection->first())
        <section class="mt-16">
            ...
            <div
                class=" flex flex-col md:flex-row items-center justify-between bg-gray-100 rounded-lg gap-4 mb-6 p-4 shadow-md">
                <!-- Pasek wyszukiwania -->
                    ...
                    <div class="relative">
                        ...
                        <div x-show="itemsPerPageOpen" @click.away="itemsPerPageOpen = false" x-cloak
                            ...
                            <ul class="divide-y divide-gray-200">
                                <li>
                                    <button @click="$wire.set('itemsPerPage', 8); itemsPerPageOpen = false"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Wyświetl 8
                                    </button>
                                </li>
                                <li>
                                    <button @click="$wire.set('itemsPerPage', 16); itemsPerPageOpen = false"
                                            class="block px-4 py-2 text-black font-medium hover:bg-gray-100 w-full text-left">
                                        Wyświetl 16
                                    </button>
                                </li>
            ...
            <div class="flex grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-between mb-10">
