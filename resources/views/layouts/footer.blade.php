<footer class="bg-[#F1FFF0] text-grey-800 py-8 bottom-0">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between">
        <!-- Logo lecznicy -->
        <div class="text-center mb-4 w-full md:w-1/3 flex justify-center md:justify-start pl-8">
        ...
        <div class="flex flex-col md:flex-row items-center md:items-start mb-6 md:mb-0 w-full md:w-1/3 md:justify-end pr-4 md:pr-10 my-10">
            <div class="mb-6 md:mb-0 text-center md:text-left">
                <h4 class="text-xl font-semibold mb-5 -mt-3">Kontakt</h4>
                <div class="flex items-center justify-center md:justify-start mb-2">
                    ...
                    <a href="https://www.google.com/maps/place/Lecznica+Weterynaryjna+%22Soczek%22/@49.6280425,20.9572105,134m/data=!3m1!1e3!4m6!3m5!1s0x473dc2822f10277f:0xc76b84267a0a0310!8m2!3d49.6281411!4d20.9574381!16s%2Fg%2F1tg_kdq4?entry=ttu" class="text-sm">Biała Niżna 345, Grybów, Polska</a>
                </div>
                <div class="flex items-center md:justify-start mb-2">
                    ...
                    <a href="tel:184450409" class="text-sm">18 445 04 09</a>
                </div>
                <div class="flex items-center md:justify-start mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                    ...
                    <a href="mailto:soczek@post.pl" class="text-sm">soczek@post.pl</a>
                </div>
                <!-- Sekcja z logo Facebooka -->
                <div class="flex items-center justify-center md:justify-end pr-4 md:pr-20 mt-12">
