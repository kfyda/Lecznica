...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-2 py-2 border-b-2 border-green-400 dark:border-green-600 text-md font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
